 ...
 * 
 */
public class AgenteDAO extends FruitoreDAO implements AgenteDAOI {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		Agente agente = new Agente("", "", "", "f@f.it", "");
		Utente utente = new Utente("Carota", "Peldì", "3333", "cama@pp.it", "rosciopowa");
		System.out.println("Registra cliente: " + dao.registraCliente(agente, utente));
		
		System.out.println("\nVisualizza clienti: " + dao.visualizzaClienti(agente));
		
		Cliente cliente = new Cliente("Alma", "Pennacchi", "333", "almaaaa@pp.it", "almone");
		System.out.println("Modifica cliente: " + dao.modificaCliente("pp@ppp.it", cliente));
		
		System.out.println("Elimina cliente: " + dao.eliminaCliente(cliente));
	}
}
